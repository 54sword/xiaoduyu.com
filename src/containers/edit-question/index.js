...
import { updateQuestionById, loadQuestionById } from '../../actions/question'
...
class EditQuestion extends React.Component {
  ...
  submitQuestion() {
    ...
    let self = this
    let { questionTitle } = this.refs
    let { updateQuestionById } = this.props
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    updateQuestionById: bindActionCreators(updateQuestionById, dispatch)
  }
}
